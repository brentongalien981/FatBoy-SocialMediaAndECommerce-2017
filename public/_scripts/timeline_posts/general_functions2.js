...
function get_post_response_bar(post) {
    ...
    $(rate_pseudo_button_img).attr("src", get_local_url() + "/public/_photos/heart.png");
    ...
    $(rate_sigma_pseudo_button_img).attr("src", get_local_url() + "/public/_photos/sum.png");
    ...
    $(rate_average_pseudo_button_img).attr("src", get_local_url() + "/public/_photos/average.png");
