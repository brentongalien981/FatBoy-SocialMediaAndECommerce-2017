...
//
//             if (response == "true") {
//                 window.alert("YOU HAVE SUCCESSFULLY POSTED A NEW POST.");
//             }
//             else {
//                 window.alert("FAILED POSTING A NEW POST.");
//             }
//
//
//             // Clear the textarea.
...
//
//
//             // Disregard this old chunk for now. This happened to be the code
//             // for displaying the new post.
//             if (response.length > 0 && response.substring(0, 1) != "0") {
//                 console.log("OK post response: " + response);
