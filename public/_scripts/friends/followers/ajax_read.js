...
function show_all_followers() {
    ...
    return;
    var url = "<?php echo LOCAL . "/public/__controller/friends/followers/Followers.php?get_all_followers=yes"; ?>";
 ...
 * @returns {undefined}
 */
function xxx_populate_suggested_friends(all_suggested_friends) {
    //
