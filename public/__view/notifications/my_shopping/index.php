<!--<link href="--><?php //echo LOCAL . "/public/_styles/notifications/my_shopping/index.css"; ?><!--" rel="stylesheet" type="text/css">-->


<?php // require_once(PUBLIC_PATH . "/__view/notifications/my_shopping/create.php"); ?>
<?php  require_once(PUBLIC_PATH . "/__view/notifications/my_shopping/read.php"); ?>
<?php // require_once(PUBLIC_PATH . "/__view/notifications/my_shopping/update.php");   ?>
<?php // require_once(PUBLIC_PATH . "/__view/notifications/my_shopping/delete.php");   ?>


<script src="<?php echo LOCAL . "/public/_scripts/notifications/my_shopping/instance_vars.js"; ?>"></script>
