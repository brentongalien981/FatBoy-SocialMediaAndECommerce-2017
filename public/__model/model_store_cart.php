...
class StoreCart {
    ...
    protected static $db_fields = array("cart_id", "seller_user_id", "buyer_user_id", "is_complete");
    public $cart_id;
...
//            $objects_array[] = self::instantiate($row);
    ...
    public static function get_initialized_cart($buyer_user_id) {
...
//        $query .= "ORDER BY name ASC";
    ...
    public function create_with_bool() {
        ...
        if ($query_result) {
            $this->cart_id = $database->get_last_inserted_id();
            return true;
        } else {
            return false;
        }
    ...
    public static function delete($id = 0) {
        ...
        $query .= "WHERE cart_id = " . $database->escape_value($id) . " ";
        $query .= "LIMIT 1";
