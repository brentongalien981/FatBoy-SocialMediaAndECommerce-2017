...
class UserHostedAd {
    ...
    protected static $table_name = "UserHostedAd";
    protected static $db_fields = array("id", "user_id", "ad_id", "num_air_hosted", "allotment_percentage", "status_id");
    public $id;
    public $user_id;
    public $ad_id;
    public $num_air_hosted;
    public $allotment_percentage;
    public $status_id;
