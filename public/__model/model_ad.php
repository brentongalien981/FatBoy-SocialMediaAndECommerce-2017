...
class Ad {
    ...
    protected static $db_fields = array("id", "producer_user_id", "ad_name", "description", "photo_url_address", "num_aired", "target_num_airings", "budget", "air_time", "status_id");
    public $id;
    public $producer_user_id;
    public $ad_name;
    public $description;
