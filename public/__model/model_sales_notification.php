...
class SalesNotification {
    ...
    protected static $table_name = "SalesNotification";
    protected static $db_fields = array("id", "notified_user_id", "notifier_user_id", "invoice_item_id", "notification_type", "is_active");
    public $id;
