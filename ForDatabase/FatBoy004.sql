...
--
-- Host: localhost
-- Generation Time: Jul 03, 2017 at 08:36 AM
...
(3, 8, 'McDonalds - Fries & Burger', 'McDonalds - Fries & Burger', 'https://www.mcdonalds.com/content/dam/usa/promotions/desktop/evm__750x537.jpg', 46, 100, 10, 5, 1, '2017-05-11 02:22:53'),
...
(5, 10, 'Dexter Javier - Remax Ad', 'Remax Remax Remax Remax Remax Remax Remax Remax Remax Remax Remax Remax Remax Remax Remax Remax', 'http://localhost/myPersonalProjects/FatBoy/public/_photos/remax.png', 34, 200, 150, 5, 1, '2017-05-11 16:40:45'),
...
(8, 10, 'Nike - Sharapova - Australian 2013 Open', 'Maria', 'https://drive.google.com/file/d/0B10DknwLh12RWndEdWkzVjd4YjA/preview', 269, 500, 5000, 12, 1, '2017-05-12 03:06:24'),
(9, 10, 'Justin Bieber - 2016 World Tour', 'Justin Bieber - 2016 World Tour Justin Bieber - 2016 World Tour', 'https://drive.google.com/file/d/0B10DknwLh12RUDg3dnIwS0dzNVU/preview', 75, 1500, 300, 50, 1, '2017-05-12 03:53:11'),
(10, 8, 'Nike - LeBron James - Witness', 'Nike - LeBron James - Witness', 'https://drive.google.com/file/d/0B10DknwLh12RczB0b1c1bldib2s/preview', 67, 500, 130, 30, 1, '2017-05-12 04:03:13'),
(11, 8, 'Apple - iPhone7 - Tokyo', 'Pictures shot in iPhone7.', 'https://www.youtube.com/embed/4nbhfrQfRRE?rel=0&controls=0&showinfo=0&autoplay=1&loop=1', 79, 35000, 10000, 60, 1, '2017-05-12 04:27:04'),
(12, 9, 'Jordan - AJXXXI: Runway', 'Some run, some make runways. #AJXXXI', 'https://www.youtube.com/embed/9J75J2CYjzs?rel=0&amp;controls=0&amp;showinfo=0&autoplay=1&loop=1', 538, 1000, 100, 90, 1, '2017-05-12 17:31:06');
...
(39, 54, 8, 8, '2017-06-15 12:37:54', 'tae'),
(40, 53, 8, 8, '2017-06-15 12:38:42', 'vaket?'),
(41, 53, 8, 9, '2017-06-15 12:39:08', 'wala lang'),
(42, 53, 8, 8, '2017-06-15 12:39:47', 'si cj');
...
(51, 8, 8, '2017-06-15 12:16:22', 'h'),
(52, 8, 8, '2017-06-15 12:19:35', 'ano'),
(53, 8, 9, '2017-06-15 12:28:55', 'hoy'),
(54, 8, 8, '2017-06-15 12:37:00', 'knlknlkn');
...
(1, 8, 3, 46, 0, 1, '2017-05-11 03:07:04'),
(3, 10, 1, 34, 10, 1, '2017-05-11 03:25:17'),
(4, 8, 2, 444, 0, 1, '2017-05-11 03:30:37'),
(5, 8, 4, 7, 53.21, 1, '2017-05-11 16:43:07'),
(6, 9, 2, 32, 0, 1, '2017-05-12 00:32:01'),
(7, 9, 1, 46, 10, 1, '2017-05-12 00:35:12'),
(8, 8, 5, 27, 70.46, 1, '2017-05-12 02:16:09'),
(9, 9, 6, 37, 0, 1, '2017-05-12 02:28:34'),
(10, 8, 7, 123, 0, 1, '2017-05-12 02:48:29'),
(11, 8, 8, 269, 0, 1, '2017-05-12 03:08:04'),
(12, 8, 9, 75, 0, 1, '2017-05-12 03:55:23'),
(13, 10, 10, 67, 25.03, 1, '2017-05-12 04:04:19'),
(14, 10, 11, 79, 29.41, 1, '2017-05-12 04:28:57'),
(15, 8, 12, 502, 0, 1, '2017-05-12 17:33:04'),
(16, 9, 12, 36, 0, 1, '2017-05-14 02:27:27'),
(17, 9, 5, 7, 70.46, 1, '2017-07-01 23:06:03');
...
INSERT INTO `Users` (`user_id`, `user_name`, `email`, `hashed_password`, `user_type_id`, `signup_token`, `private`) VALUES
(8, 'bren', '', '$2y$10$NUvesdcKf749dWYzg2Ll/Ok88DKAOoJF2gU5eUo3DHMgg55/CfBaW', 1, NULL, b'0'),
(9, 'c', '', '$2y$10$K5SpUutbvfrIw2gmi5pDh.SjhfCIah2n.kgmK8W285vwwB/KL0q9.', 1, NULL, b'1'),
(10, 'ye', '', '$2y$10$YJ4PuMoBFbjECsCouWi1/OXSM4E9adnyT47LcaXvgEvWOG0yO0VXS', 1, NULL, b'1'),
(11, 'apesapes123', '', '$2y$10$aOgIUHN8sb30x7uKA14QMe5QPoqmnmjeKljmCTITY5.HedkxGYsW6', 1, NULL, b'1'),
(12, 'kobekobe123', '', '$2y$10$sKJjEP.JlR3zUjs8VxwhiOlCGtiOyGV7S0LKs/WGl3psTHxpwSRkW', 1, NULL, b'0'),
(13, 'johnjohn123', '', '$2y$10$6ieChkTpeDxadg03ebcrJeOtQaegjldDqYTGTjLGkbPX3xsUyp8Oi', 1, NULL, b'1'),
(14, 'UserForOneTimeAddresses123', '', '$2y$10$R8nKvfFjh4oj5wMfqoMreePXh1VrgyZvxFMeeUG2ZJ2RgpgwIMD3a', 1, NULL, b'1'),
(15, 'leilei123', '', '$2y$10$JcHTcbO94oJbaKdIkAf9J.5U9qXmh4lD/2fa7.Or9CXXqMNYWk.fu', 1, NULL, b'1'),
(34, 'brenbren123', 'brenallen1.1x10e11@gmail.com', '$2y$10$cBKKHyrTd5oW28BNd/QMEu30Ua0WuEMQ0cOX6kxzFNrdZtUOTWBKC', 1, '8502a06cf78668198f041d5632223cf1', b'1'),
(38, 'odoxodox123', 'o@a.com', '$2y$10$QxRDNI72URr1uTk5whz1zOpaZB3jaX2TqAA7X2YWnZHA9RkrUPYma', 1, '39c66d966324929b8f7d75bb42b86bee', b'1'),
(58, 'opsops123', 'odox700@gmail.com', '$2y$10$0ljQR1FSbmKYDAy6TOHg2OHM.obn6KPfRvGWDEGaySNOs74Gd76nu', 1, 'ac2bb09384be96f7b49aafadca3e55a8', b'1');
